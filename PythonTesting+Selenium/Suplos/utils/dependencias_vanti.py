...
USER = [
        "maria_azuaje@suplos.com", #tipo 2
        ...
        "vicepresidencia_rep_27@suplos.com" #!Vicepresidente  falla el usuario
        ...
        "ProfesionalareausuariaProfesionalCXP@suplos.com", #?Profesional area usuaria / Profesional CXP
        "Usuario_profesional_seguros@suplos.com" #?profesional seguros
]
